...
namespace BattleForAzeroth.Game.CardLibrary.Servant.Neutral.Classical
{
    ...
    {
        public override string CardCode => "041";
        ...
        public override ICardAbility CardAbility { get; internal set; } = new AfterICastSpellDriver<RiseDamage<AllServantFilter, ONE, ONE, SpellDamage>, InDeskFilter>();
