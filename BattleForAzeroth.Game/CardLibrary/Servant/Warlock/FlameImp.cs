...
namespace BattleForAzeroth.Game.CardLibrary.Servant.Warlock
{
    ...
    {
        public override string CardCode => "042";
        ...
        public override ICardAbility CardAbility { get; internal set; } = new NoneTargetBattlecryDriver<RiseDamage<PrimaryHeroFilter, Three, ONE, PhysicalDamage>>();
