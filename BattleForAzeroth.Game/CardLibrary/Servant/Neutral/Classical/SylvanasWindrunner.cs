...
namespace BattleForAzeroth.Game.CardLibrary.Servant.Neutral.Classical
{
    ...
    {
        public override string CardCode => "026";
        ...
        public override ICardAbility CardAbility { get; internal set; } = new DeathWhisperDriver<Possession<NotPrimaryUserContextFilter, NotPrimaryRandomServantFilter>, InDeskFilter>();
