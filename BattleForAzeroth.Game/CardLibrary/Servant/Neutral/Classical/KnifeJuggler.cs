...
namespace BattleForAzeroth.Game.CardLibrary.Servant.Neutral.Classical
{
    ...
    {
        public override string CardCode => "013";
        ...
        public override ICardAbility CardAbility { get; internal set; } = new CastMyServantDriver<RiseDamage<AllSecondaryRandomBiologyFilter, ONE, ONE, PhysicalDamage>, InDeskFilter>();
