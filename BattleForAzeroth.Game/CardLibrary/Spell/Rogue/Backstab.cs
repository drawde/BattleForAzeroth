...
namespace BattleForAzeroth.Game.CardLibrary.Spell.Rogue
{
    public class Backstab : BaseSpell
    {
        ...
        public override ICardAbility CardAbility { get; internal set; } = new SpellDriver_Single_AllEnemyServant<RiseDamage<SecondaryServantFilter, Two, ONE, SpellDamage>>();
