...
namespace BattleForAzeroth.Game.CardLibrary.Servant.Neutral.Classical
{
    ...
    {
        public override string CardCode => "077";
        ...
        public override ICardAbility CardAbility { get; internal set; } = new NoneTargetBattlecryDriver<RiseDamage<DeskCardRandomFilter, ONE, Three, PhysicalDamage>>();
