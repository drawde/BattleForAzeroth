...
namespace BattleForAzeroth.Game.CardLibrary.Spell.Warrior
{
    public class BattleRage : BaseSpell
    {
        ...
        public override ICardAbility CardAbility { get; internal set; } = new NoneTargetSpellDriver<DrawCard<PrimaryUserContextFilter, GetDynamicNumber<InjuredCardsFilter<MyBiologyFilter>>>>();
