...
namespace BattleForAzeroth.Game.CardLibrary.Servant.Neutral.Classical
{
    ...
    {
        public override string CardCode => "029";
        ...
        public override ICardAbility CardAbility { get; internal set; } = new HurtDriver<DrawCard<PrimaryUserContextFilter, ONE>, InDeskFilter>();
